package com.example.hasee.filedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fDataStoreage = Environment.getDataDirectory();
    ...
    public void externalStoragePulicDirectory(View v){
    ...
    public void dataStoreage(View v){
        path = fDataStoreage.getAbsolutePath();
        listFiles(path);
    }
